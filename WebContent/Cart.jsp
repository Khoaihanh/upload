                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="o">
                                                <tr>
                                                    <th scope="row">
                                                        <div class="p-2">
                                                            <img src="${o.product_img_source}" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="sub?id=${o.product_id}"><button class="btnSub">-</button></a> <strong>${o.amoun}</strong>
                                                        <a href="cart?id=${o.product_id}"><button class="btnAdd">+</button></a>
                                                    </td>
                                                            <td class="align-middle"><a href="remove?id=${o.product_id}" class="text-dark">
